                ...
                <div class="col-md-6">
                    <div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
                        <div class="carousel-inner w-100" role="listbox">
                            ...
                            <?php foreach( array_slice($footerTop,0,4) as $value){ ?>
                                <div class="col-3 float-left"><img src="<?php echo $value ?>" class="img-responsive"></div>
                            <?php } ?>
                            </div>
                            <div class="carousel-item row no-gutters"> 
                                <?php foreach(array_slice($footerTop, 4, 7) as $value){ ?>
                                <div class="col-3 float-left"><img src="<?php echo $value ?>" class="img-responsive"></div>
                            <?php } ?>
                            </div>
                        </div>
